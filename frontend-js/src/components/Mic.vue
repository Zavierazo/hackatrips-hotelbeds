<template>
    <div class="mic">
        ...
        <div class="mic__bottom">
            <label for="mic-search" class="mic__caption">Manten pulsado para grabar o introduce tu busqueda</label>
            <input type="text" id="mic-search" class="mic__input" placeholder="¿Donde quieres ir?">
        </div>
    </div>
</template>
